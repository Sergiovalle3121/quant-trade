...
ML alpha lab outputs are research-only and must show `real_money_ready=false`. Leakage, overfitting, unstable features, transaction costs, and benchmark underperformance must be documented before any later human review.
