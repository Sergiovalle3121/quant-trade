...
COPY_PT: dict[str, str] = {
    ...
    "protect_title": "Proteção da sua conta",
    "protect_count": "{on} de {total} ativas",
    "protect_all": "Você tem ativas todas as proteções que oferecemos.",
    "protect_recovery": "Chave de recuperação",
    "protect_two_step": "Verificação em duas etapas",
    "protect_two_step_why": "Além da senha, um código de um app no seu celular.",
    "protect_two_step_needs": "Primeiro crie sua chave de recuperação.",
    "protect_passkey": "Chave de acesso",
    "protect_passkey_why": "Entre com a digital, o rosto ou o PIN, sem digitar a senha.",
    "protect_on": "Ativa",
    "protect_go_recovery": "Criar",
    "protect_go_two_step": "Ativar",
    "protect_go_passkey": "Adicionar",
