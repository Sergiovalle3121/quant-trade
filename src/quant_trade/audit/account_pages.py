...
COPY: dict[str, dict[str, str]] = {
    "es": {
        ...
        "stores": (
            ...
            "informe a los {days} días (queda solo su huella); los pagados quedan para que "
            "sigas abriéndolos.|"
    ...
    "en": {
        ...
        "stores": (
            ...
            "report after {days} days (only their fingerprint stays); paid ones stay so you can "
            "keep opening them.|"
