...
.btn-block{width:100%}
.link-more{display:inline-flex;align-items:center;gap:6px;min-height:44px;color:var(--accent);font-weight:500;
...
.flag-cards .flag-code{margin-top:6px;font-family:var(--mono);font-size:.72rem;letter-spacing:.04em;color:var(--text-3)}.nm-list{list-style:none;margin:14px 0;padding:0;background:#fff;border:1px solid var(--border);border-radius:14px}.nm-list li{padding:12px 18px;border-top:1px solid var(--border)}.nm-list li:first-child{border-top:0}@media print{.flag-cards li,.nm-list li{break-inside:avoid;page-break-inside:avoid}}.nm-list b{display:block;font-weight:600;font-size:.95rem}.nm-list span{display:block;margin-top:2px;color:var(--text-2);font-size:.9rem;line-height:1.5}
